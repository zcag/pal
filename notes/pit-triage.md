...
Close behind (pulled 2026-09-17, `notes/decisions.md` "Decided: expansion, folder browsing, store palette, theme file, screenshots, compact"): 106 snippet expansion, 339 folder browsing in Files, 257 an in-panel store palette, 43 a theme file, 102 a screenshots palette, 3 compact mode. Left: 74 the rest of the clipboard actions (M/M).
