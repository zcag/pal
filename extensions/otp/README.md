...
tooltip). Hidden the rest of the time; `show = "always"` under
`[bar.items."otp/latest-code"]` keeps the glyph, muted, between codes,
its popover saying so and opening the palette (docs/config.md).
