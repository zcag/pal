...
export type Settings = { auth: "app" | "token"; token: string; workspace: string; statuses: string[]; dm_urgent: boolean; presence: boolean; refresh: number; bar_show?: "auto" | "unread" | "always" };
