...
glyph stays on the bar while nothing is unread, and the popover lists
the recent chats instead.
...
| `unread_only_bar` | boolean | `true` | Hide the bar item at zero; off keeps the glyph as a way into the popover. |
