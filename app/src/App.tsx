...
export default function App() {
  ...
  return <Launcher ref={launcher} sources={sources} search={search} detail={detail} version={version} mark={mark} onHide={() => invoke("hide")} onPick={pick} onSettings={() => invoke("settings_open")} />;
}
