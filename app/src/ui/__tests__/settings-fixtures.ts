...
export const barItems: BarItem[] = [
  ...
  { key: "timer/running", extension: "timer", id: "running", title: "Running timers", extTitle: "Timer", source: true, refreshEvery: 60, renderedAt: Math.floor(Date.now() / 1000) - 3600, stale: true, state: { title: "tea 12:00", hidden: false, urgent: false, icon: "\u{f0954}", progress: 0.4, color: "amber" }, config: { enabled: true, target: "sketchybar", position: "left", hotkey: "ctrl+alt+t", openOnHover: false, order: 2, look: { font: "mono", width: 64 } } },
