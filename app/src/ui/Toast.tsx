...
/** Bottom-left transient notice. `animated` shows a spinner for work in progress; a failure is announced assertively. */
export function Toast({ toast }: { toast: ToastSpec }) {
  return (
    <div className="pal-toast" data-style={toast.style} role={toast.style === "failure" ? "alert" : "status"}>
