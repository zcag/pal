...
Minesweeper, Solitaire and Yahtzee draw their own page instead, a
`surface` node (`extensions/{blackjack,minesweeper,solitaire,yahtzee}/surface/`).
...
Minesweeper, Solitaire and Yahtzee are full games on it.
